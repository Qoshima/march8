(() => {
    ...
    const wishTemplates = [
        "Дорогая {{name}}, пусть эта весна принесет тебе спокойствие в голове, уверенность в себе и много поводов улыбаться. Пусть учеба идет легче, планы складываются, а рядом будут люди, с которыми тепло и безопасно. С праздником! 💐",
